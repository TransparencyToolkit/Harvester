...
Welcome to Neo4j release 2.2.7, a high-performance graph database.
...
For full instructions, see http://neo4j.com/docs/2.2.7/deployment.html
...
* Getting Started: http://neo4j.com/docs/2.2.7/introduction.html
* The Neo4j Manual: http://neo4j.com/docs/2.2.7/
